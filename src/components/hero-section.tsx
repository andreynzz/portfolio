"use client"; // Importante: Define como Client Component
    ...
    <div className="relative min-h-screen text-[#F5F5F5] p-4 md:p-6 font-mono overflow-x-hidden">
      <LazyMotion features={domAnimation}>
        ...
        >
          ...
          {/* Links Sociais */}
          <m.div variants={itemVariants} className="flex flex-wrap justify-center items-center gap-4 md:gap-6 text-white/40 pb-8 md:pb-0">
